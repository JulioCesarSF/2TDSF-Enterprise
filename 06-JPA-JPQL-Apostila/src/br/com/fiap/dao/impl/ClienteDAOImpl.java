...
public class ClienteDAOImpl extends GenericDAOImpl<Cliente, Integer> implements ClienteDAO {
	...
	public List<Cliente> buscarPorEstado(String estado) {
		TypedQuery<Cliente> query = em.createQuery("from Cliente c where c.endereco.cidade.uf = :D", Cliente.class);
	...
	public List<Cliente> buscar(String nome, String cidade) {
		return em
				.createQuery("from Cliente c where c.nome like :n" + " and c.endereco.cidade.nome like :c",
						Cliente.class)
	...
	@Override
	public List<Cliente> buscarPorAniversario(int mes) {
		return em.createNamedQuery("Cliente.porAniversario", Cliente.class).setParameter("niver", mes).getResultList();
	}
